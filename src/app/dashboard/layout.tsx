  ...
  return (
    <div className="flex h-screen w-screen bg-(--theme-bg)">
      ...
      <main className="flex-1">
        {/* Top Bar */}
        <header className="sticky top-0 z-30 flex h-16 items-center justify-between border-b border-zinc-200 bg-white/80 px-8 backdrop-blur-sm dark:border-zinc-800 dark:bg-zinc-950/80">
          <h1 className="text-lg font-semibold text-zinc-900 dark:text-zinc-100">
            Dashboard
          </h1>
          <Link
            href="/"
            className="mr-2 ml-auto text-sm text-zinc-500 transition-colors hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-zinc-100"
          >
            ← Back to site
          </Link>
          <ThemeToggle />
